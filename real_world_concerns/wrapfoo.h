#ifdef __cplusplus
#include "foo.hpp" // let us see the implementation
extern "C"
{
#else
typedef struct Frobulator Frobulator; // opaque struct for type safety in C callers
#endif
...
int foo_compute(const Frobulator *frobulator, const double *data, double *result, int len, foo_error **err);
